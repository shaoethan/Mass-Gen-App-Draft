...
export default function RecordScreen() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Upstairs Recording Screen</Text>

      <View style={styles.instructionsBox}>
        <Text style={styles.instructionsTitle}>Instructions</Text>
        <Text style={styles.instructionsText}>
          • Walk upstairs at a natural pace without pausing for at least 20
          seconds.{"\n"}• Use a band to attach the phone securely to your chosen
          location.{"\n"}• Try to maintain a consistent rhythm throughout the
          climb.
        </Text>
      </View>
