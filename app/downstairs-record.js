...
export default function RecordScreen() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Downstairs Recording Screen</Text>

      <View style={styles.instructionsBox}>
        <Text style={styles.instructionsTitle}>Instructions</Text>
        <Text style={styles.instructionsText}>
          • Walk downstairs at a natural, controlled pace without rushing for at
          least 20 seconds.{"\n"}• Use a band to attach the phone securely to
          your chosen location.{"\n"}• Keep your movements steady and avoid
          abrupt steps.
        </Text>
      </View>
